...
- [ ] **T88** ⚡ ⭐⭐⭐ - Thumbnails sometimes display **upside down / sideways**
  ...
  - **Still open**: not closing this out — added the key fix as a real, defensible improvement, but not confident it's the fix given the counter-evidence above. Needs real-device confirmation on the next reproduction
